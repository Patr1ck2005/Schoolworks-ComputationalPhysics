...
# 随机数个数的范围
Log_N_values = np.linspace(2, 7, 100)  # 生成100到1000000之间的100个数
# print(N_values)
...
plt.plot(np.linspace(2, 7, 100), -0.5 * np.linspace(2, 7, 100))
plt.plot(np.linspace(2, 7, 100), -2 / 3 * np.linspace(2, 7, 100))
plt.plot(np.linspace(2, 7, 100), -1 * np.linspace(2, 7, 100))
